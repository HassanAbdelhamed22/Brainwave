      ...
      <div className="container">
        ...
        <div className="relative">
          ...
          >
            ...
            <Generating className="absolute left-4 bottom-4 right-4 border border-n-1/10 lg:left-1/2 lg:right-auto lg:-translate-x-1/2 lg:bottom-8" />
          </motion.div>
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            <motion.div
              ...
              initial="hidden"
              whileInView="visible"
              className="p-4 bg-n-7 lg:min-h-[46rem] rounded-3xl overflow-hidden"
            >
                ...
                <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        <img src={item} alt={item} width={28} height={28} />
                      </div>
                    </li>
                  ))}
                </ul>
